...
function ju52.flightstep(self)
    ...
    if math.abs(longit_speed) > tail_lift_min_speed and math.abs(longit_speed) < tail_lift_max_speed then
        ...
        if newpitch > math.rad(17.4) then newpitch = math.rad(17.4) end --não queremos arrastar o cauda no chão
    else
        if math.abs(longit_speed) < tail_lift_min_speed then newpitch = math.rad(17.4) end
    end
